...
mediaFolder|Media Folder|Select the folder that you uploaded the images to in the OctoberCMS Media manager. Only folders under the base folder set on the November Gallery settings page are valid.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTA2OTMwNTcsLTE2MjM3MTI0MjQsLT

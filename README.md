...
galleryLayout|Gallery Layout|Select a gallery layout, or select "default" to use the gallery layout set on the plugin settings page.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUwOTk2MjQzNSwtMTYyMzcxMjQyNCwtMT

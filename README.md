...
`galleryLayout`|Gallery Layout|Select a gallery layout.<br>Possible values are:<br>- default / Default (use the gallery layout set on the plugin settings page)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzI1MTI0MTAsLTE2MjM3MTI0MjQsLT
